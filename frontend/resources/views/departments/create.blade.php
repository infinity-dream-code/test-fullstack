...
<div class="container">
    <div class="form-container">
        <div class="form-header">
            <h2><i class="fas fa-building-plus me-3"></i>Add New Department</h2>
            <p class="subtitle">Create a new department with schedule settings</p>
        </div>

        <div class="form-body">
            <div class="form-tips fade-in">
                <h6><i class="fas fa-info-circle me-2"></i>Department Setup</h6>
                <p class="mb-0">Create a department and set the maximum allowed clock-in and clock-out times. These times will be used for attendance validation.</p>
            </div>
            ...
            <form action="{{ route('departments.store') }}" method="POST" id="departmentForm">
                ...
                <div class="time-preview fade-in" style="animation-delay: 0.4s;" id="timePreview" style="display: none;">
                    ...
                    <div class="time-info">
                        ...
                        <span class="time-value" id="previewClockIn">--:--</span>
                    </div>
                    <div class="time-info">
                        <span class="time-label"><i class="fas fa-sign-out-alt me-2"></i>Max Clock Out:</span>
                        <span class="time-value" id="previewClockOut">--:--</span>
                    </div>
                    <div class="time-info">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!isValid) {
            e.preventDefault();
            submitBtn.innerHTML = '<i class="fas fa-save me-2"></i>Save Department';
